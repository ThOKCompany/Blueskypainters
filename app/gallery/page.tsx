...
export default function GalleryPage() { return <><Navigation /><main><div className="pt-4"><GallerySection items={GALLERY_ITEMS} /></div><p className="bg-brand-bg px-6 pb-12 text-center text-sm text-navy/60">Temporary demonstration images shown for layout purposes; these are not confirmed Blue Sky Painter projects.</p></main><SiteFooter /></>; }
